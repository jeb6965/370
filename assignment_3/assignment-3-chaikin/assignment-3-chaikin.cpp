...
int main() {
	for(int set = 1; set < 3; set++){
		...
		std::string control_point_file = "control_points" + std::to_string(set)+ ".jpg";
		canvas.save(control_point_file.c_str());
		for (int iteration = 0; iteration < 6; iteration++){
			...
			std::string filename = "chaikin_iteration_" + std::to_string(iteration + 1) + "set" + std::to_string(set) + ".jpg";
